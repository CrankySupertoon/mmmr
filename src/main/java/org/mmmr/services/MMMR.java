...
public class MMMR implements MMMRI {
    ...
    private ModPack initJogBox(@SuppressWarnings("unused") File data) throws FileNotFoundException, JAXBException {
        ...
        yogbox.addMod(new Mod("Baby Animals", "1.7.5", "http://www.minecraftforum.net/topic/190053-173-baby-animals-v175-mobml/",
                "mods/BabyAnimals_v1_75.zip"));
        yogbox.addMod(new Mod("Mo' Creatures", "2.12.2",
                "http://www.minecraftforum.net/topic/81771-v173-mo-creatures-v2122-with-kitties-mice-and-rats/", "mods/mocreatures/"));
        yogbox.addMod(new Mod("More Health", "7.5",
                "http://www.minecraftforum.net/topic/115172-v173-noheros-mods-more-health-v75-extras-chance-sword-v15/#health", "mods/moreHealth/"));
        ...
        yogbox.addMod(new Mod("DaftPVF's mods: Treecapitator", "?", "http://www.minecraftforum.net/topic/124117-v173-daftpvfs-mods/#treecapitator",
                "mods/Treecapitator.zip"));
        yogbox.addMod(new Mod("DaftPVF's mods: Starting Inventory", "?",
                "http://www.minecraftforum.net/topic/124117-v173-daftpvfs-mods/#starting_inventory", "mods/Starting Inventory.zip"));
        yogbox.addMod(new Mod("Risugami's Mods: Shelf Beta", "1.7.3",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/", "mods/Shelf.zip"));
        yogbox.addMod(new Mod("Risugami's Mods: Recipe Book Beta", "1.7.3",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/", "mods/Recipe Book.zip"));
        yogbox.addMod(new Mod("Mystic Mods: Mystic Ruins", "0.3",
                "http://www.minecraftforum.net/topic/303729-173-mystic-mods-dungeons-ruins-ores-vines-stones/", "mods/Mystic_Ruins_v03.zip"));
        ...
        yogbox.addMod(new Mod("Hogofwar's Bone Mods: Magical Bone Sticks", "?",
                "http://www.minecraftforum.net/topic/190980-173-hogofwars-bone-mods/#bone", "mods/BoneSticks.zip"));
        ...
        yogbox.addMod(new Mod("The Seasons Mod", "1.34", "http://www.minecraftforum.net/topic/499733-173134the-seasons-mod/",
                "bin/minecraft.jar/nandonalt/Seasons/"));
        yogbox.addMod(new Mod("Mystic Mods: Mystic Ores", "0.4",
                "http://www.minecraftforum.net/topic/303729-173-mystic-mods-dungeons-ruins-ores-vines-stones/", "bin/minecraft.jar/mysticores/"));
        yogbox.addMod(new Mod("Scokeev9's mods: Randomite)", "4.0",
                ...
                "bin/minecraft.jar/scokeev/randomite.png"));
        ...
        yogbox.addMod(new Mod("DaftPVF's mods: Score", "?", "http://www.minecraftforum.net/topic/124117-v173-daftpvfs-mods/#score",
                "bin/minecraft.jar/mod_score.class"));
        yogbox.addMod(new Mod("Risugami's Mods: Elemental Arrows Beta", "1.7.3",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/", "bin/minecraft.jar/mod_Arrows.class"));
        yogbox.addMod(new Mod("Risugami's Mods: More Stackables Beta", "1.7_01",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/", "bin/minecraft.jar/mod_Stackables.class"));
        yogbox.addMod(new Mod("Risugami's Mods: ModLoader Beta", "1.7.3",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/", "bin/minecraft.jar/ModLoader.class"));
        ...
        yogbox.addMod(new Mod("Peaceful Pack", "3", "http://www.minecraftforum.net/topic/368468-173-peaceful-pack-v3/",
                "bin/minecraft.jar/mod_PeacefulPack.class"));
        ...
        yogbox.addMod(new Mod("Ninja Ghost", yogbox.getVersion(),
                "http://yogiverse.com/showthread.php?11841-YogBox-A-carefully-chosen-compilation-of-good-mods", "bin/minecraft.jar/mod_Ghost.class"));
        yogbox.addMod(new Mod("Israphel", yogbox.getVersion(),
                "http://yogiverse.com/showthread.php?11841-YogBox-A-carefully-chosen-compilation-of-good-mods", "bin/minecraft.jar/mod_Ifix.class"));
        ...
        yogbox.addMod(new Mod("Pfaeff's Mod", "0.8.3?",
                "http://www.minecraftforum.net/topic/200272-v173-pfaeffs-mod-ssp-v083-allocator-jump-pad-and-more/", "mods/Pfaeff.zip"));
        ...
        yogbox.addMod(new Mod("Scokeev9's mods: ScotTools API and Fix)", "10.1?",
                ...
                "bin/minecraft.jar/ScotTools.class"));
        yogbox.addMod(new Mod("ModOptionsAPI", "0.7?", "http://www.minecraftforum.net/topic/191591-v173-moapi-modoptionsapi-textkey-options-07/",
                "bin/minecraft.jar/modoptionsapi"));
        ...
        yogbox.addMod(new Mod("Risugami's Mods: AudioMod Beta", "1.7_01",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/", "bin/minecraft.jar/ibxm/"));
        yogbox.addMod(new Mod("Risugami's Mods: Death Chest Beta", "1.7_01",
                "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/"));// no check
        yogbox.addMod(new Mod("Biome Caves", "3?", "http://www.minecraftforum.net/topic/311162-173-biome-caves-ice-and-sand-dungeons-v3/",
                "bin/minecraft.jar/mod_Icecave.class"));
