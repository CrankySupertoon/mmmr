...
public class MMMR implements StartMe {
	...
	yogbox.addMod(new Mod("Pfaeff's Mod", "0.8.3?", "http://www.minecraftforum.net/topic/200272-v173-pfaeffs-mod-ssp-v083-allocator-jump-pad-and-more/"));
	...
	yogbox.addMod(new Mod("Scokeev9's mods: BiomeWater", "3.0?", "http://www.minecraftforum.net/topic/228940-173scokeev9-premiumwood-v144-12-more-thanks-for-250000-dls/#water"));
	...
	yogbox.addMod(new Mod("Mo' Creatures", "2.12.2", "http://www.minecraftforum.net/topic/81771-v173-mo-creatures-v2122-with-kitties-mice-and-rats/"));
	...
	yogbox.addMod(new Mod("Risugami's Mods: Death Chest Beta", "1.7_01", "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/"));
	yogbox.addMod(new Mod("Risugami's Mods: Shelf Beta", "1.7.3", "http://www.minecraftforum.net/topic/75440-v173-risugamis-mods-recipe-book-updated/"));
	...
	yogbox.addMod(new Mod("Hogofwar's Bone Mods: Magical Bone Sticks", "?", "http://www.minecraftforum.net/topic/190980-173-hogofwars-bone-mods/#bone"));
	...
	while (!allSuccess) {
		...
		try {
		    ...
		    startMC(true);
		    JOptionPane.showMessageDialog(null, "After you started Minecraft once.\nContinue.");
		...
		if (!cfg.getMcJarBackup().exists() && !"true".equals(cfg.getProperty("jogbox.ignore", "?"))) {
		    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null, "Do you want to install YogBox (you need to have downloaded it already)?", "YogBox",
